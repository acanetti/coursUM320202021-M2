...
Par groupes de 5 : développer un serveur node.js qui fournit un jeu de données produit par le croisement d'au moins de jeux de données récupérés sur le Web.
